...
const Page = () => {
    ...
    return (
        <div className="w-[100dvw] h-auto min-h-[100dvh] flex-col hide-scrollbar relative dark:bg-dark_bg">
            <div
                className="bg-[url('../public/Bg-home.png')] bg-cover flex flex-col justify-center pt-[30dvh] min-w-[100dvw] min-h-[80dvh] ">
            ...
            <div className="flex flex-col px-10 md:px-20 w-[100dvw] h-auto">
                <div className="flex flex-col md:flex-row gap-y-8 gap-x-5 items-start pt-[10dvh]">
                    ...
                    <div
                        className="bg-[#F4F4F4] w-full md:w-[40%] border rounded-lg flex flex-col h-fit min-h-full max-h-fit pb-2 dark:bg-black dark:text-white">
                ...
                <div className="flex flex-col md:flex-row gap-y-8 gap-x-5 pt-20 dark:text-white">
                    ...
                    <div
                        className="bg-black md:w-[40%] border rounded-lg flex flex-col h-fit min-h-full md:min-h-[300px]  pb-2 justify-between ">
                        <div
                            className="ml-auto mr-auto flex mt-4 items-center justify-center w-12 h-12 bg-white rounded-full">
