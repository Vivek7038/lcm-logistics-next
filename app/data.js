export const FaqData = [
    {
        ques: "How can you organize storage areas for bulk items? ",
        ans: `Lorem ipsum dolor sit amet consectetur. Varius risus montes morbi ultrices sed ut. Lorem.Lorem ipsum dolor sit amet consectetur. Varius risus montes morbi ultrices sed ut. Lorem.`
    },
    {
        ques: "What is an Advance Shipping Notice (ASN)?",
        ans: `Lorem ipsum dolor sit amet consectetur. Varius risus montes morbi ultrices sed ut. Lorem.Lorem ipsum dolor sit amet consectetur. Varius risus montes morbi ultrices sed ut. Lorem.`
    },
    {
        ques: "How can you organize storage areas for bulk items? ",
...
export const data = [
    ...
    },
    {
        ...
        desc: `Our state-of-the-art facilities are equipped with advanced refrigeration systems and monitoring technology to ensure optimal storage conditions for perishable goods. From food and pharmaceuticals to floral and chemical products, we provide a secure and controlled environment to preserve the integrity of your cargo throughout its journey.
        At our cold chain warehouses, we prioritize precision and reliability, adhering to strict quality control measures and regulatory standards. Our experienced team meticulously manages inventory, temperature monitoring, and handling procedures to safeguard the freshness and efficacy of your products.
        With our comprehensive cold chain solutions, you can trust us to deliver peace of mind along with your cargo. Whether you require short-term storage or long-term warehousing, we offer flexible options to accommodate your needs. Our commitment to excellence extends beyond storage, as we provide value-added services such as inventory management, repackaging, and distribution.
    ...
    },
    {
        ...
        desc: `Our warehouses are strategically located for convenient access and efficient distribution, ensuring seamless handling of your inventory. With spacious storage facilities and robust security measures, we prioritize the safety and security of your products throughout their stay.
        At our traditional warehouses, we offer flexible storage options to accommodate your unique needs, whether you require short-term storage or long-term warehousing solutions. Our experienced team manages inventory with precision, utilizing advanced inventory management systems to track and monitor stock levels in real-time.
        In addition to storage, we provide value-added services such as order fulfilment, labelling, and packaging to streamline your supply chain and enhance efficiency. With our commitment to excellence and customer satisfaction, you can trust us to deliver reliable and cost-effective warehousing solutions tailored to your business requirements.
    ...
    {
        name: "CFS/ICDs ",
        desc: `Our Container Freight Stations (CFS) and Inland Container Depots (ICD) serve as vital hubs for the efficient movement of goods, offering a range of services to optimize your supply chain.
        At our CFS/ICD facilities, we provide secure storage, efficient cargo handling, and seamless connectivity to major transportation networks. Whether you're importing, exporting, or transhipping cargo, our strategically located facilities ensure quick turnaround times and cost-effective solutions.
        Our experienced team manages every aspect of your cargo, from unloading containers to customs clearance and onward delivery. With advanced technology and streamlined processes, we ensure transparency and accountability at every stage of the logistics chain.
