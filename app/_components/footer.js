        ...
        <div className={"w-[100%] relative"}>
            <div className={"flex w-[100%] bg-black lg:py-12 py-6 md:py-8 lg:px-40 md:px-4 md:justify-between flex-col md:flex-row items-center"}>
                ...
                <div className={"w-[80%] lg:w-72 md:w-56 text-white flex flex-col gap-4 items-center md:items-start"}>
                    <p>Join Group</p>
                    <div className={"flex"}>
                        <input className={" w-48  lg:w-60  md:w-36 px-4 h-12 outline-0 border-0 text-black"} type={"email"}
                    ...
                    <div className={"flex w-[90%] justify-between"}>
                        <a href={""}>
                            <svg className={"w-[24px] h-[24px]  md:w-[32px] md:h-[32px] "} viewBox="0 0 32 29" fill="none"
                        ...
                        <a href={""}>
                            <svg className={"w-[24px] h-[24px]  md:w-[32px] md:h-[32px] "}  viewBox="0 0 32 32" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <a>
                            <svg className={"w-[24px] h-[24px]  md:w-[32px] md:h-[32px] "}  viewBox="0 0 32 23" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
