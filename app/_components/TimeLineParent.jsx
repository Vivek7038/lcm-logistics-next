    ...
    <div class="w-full max-w-3xl mx-auto">
      <div class="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-300 before:to-transparent">
        ...
        {TimeLineData.map((item, index) => (
          ...
          >
            {/* <!-- Icon --> */}
            <div class="flex items-center justify-center w-10 h-10 rounded-full border dark:border-white bg-slate-300 group-[.is-active]:bg-white text-slate-500 group-[.is-active]:text-emerald-50 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2">
            ...
            {/* <!-- Card --> */}
            <div class="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-white dark:bg-dark_bg p-4 rounded  dark:border-slate-200 dark:shadow text-black dark:border-0">
              <div className="border-[2px] border-[#B1C2F3] flex flex-col sm:flex-row justify-between px-6 rounded-[12px] gap-x-2 dark:bg-dark_bg ">
                ...
                <div className="flex flex-col items-center justify-between py-4 px-2">
                  <h1 className="text-md text-[#838383] text-wrap text-center">
